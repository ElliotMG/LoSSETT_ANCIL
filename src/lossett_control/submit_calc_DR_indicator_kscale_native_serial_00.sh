...
#SBATCH --output=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_00Z_%a_%j.out      # output file
#SBATCH --error=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_00Z_%a_%j.err       # error file
...
python3 -m LoSSETT.control.run_lossett_kscale_native "DYAMOND3" "n2560RAL3" "none" 2020 9 ${SLURM_ARRAY_TASK_ID} "00" ${max_r_deg} "none" 500
