...
# Output & monitoring
#SBATCH --job-name="calc_DR_kscale_native_serial_12Z"         # job name
#SBATCH --output=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_12Z_%a.out      # output file
#SBATCH --error=/home/users/dship/log/log_calc_DR_indicator_kscale_native_serial_12Z_%a.err       # error file
